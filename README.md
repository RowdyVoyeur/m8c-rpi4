...
- Amidiminder utility (more information [here](https://github.com/mzero/amidiminder) and [here](https://community.blokas.io/t/amidiminder-utility/2243/1)) reads its MIDI rules from the file `/etc/amidiminder.rules`.
